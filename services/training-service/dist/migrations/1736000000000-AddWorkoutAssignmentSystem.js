...
exports.AddWorkoutAssignmentSystem1736000000000 = void 0;
const typeorm_1 = require("typeorm");
class AddWorkoutAssignmentSystem1736000000000 {
    async up(queryRunner) {
        ...
        await queryRunner.createIndex('workout_assignments', new typeorm_1.Index({
        ...
        await queryRunner.createIndex('workout_player_overrides', new typeorm_1.Index({
        ...
        await queryRunner.createIndex('player_progression_history', new typeorm_1.Index({
...
exports.AddWorkoutAssignmentSystem1736000000000 = AddWorkoutAssignmentSystem1736000000000;
//# sourceMappingURL=1736000000000-AddWorkoutAssignmentSystem.js.map