...
router.get('/templates', async (req, res) => {
    try {
        ...
        const templateRepo = database_1.AppDataSource.getRepository(entities_1.ExerciseTemplate);
        ...
        // Apply pagination
        const result = await (0, shared_lib_1.paginate)(query, paginationParams);
