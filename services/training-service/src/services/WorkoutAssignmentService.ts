...
import { BaseService, Logger, CacheService } from '@hockey-hub/shared-lib';
import { 
...
export class WorkoutAssignmentService extends BaseService<WorkoutAssignment> {
  ...
  constructor() {
    super(AppDataSource.getRepository(WorkoutAssignment));
