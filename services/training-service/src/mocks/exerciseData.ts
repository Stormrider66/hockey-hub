import { ExerciseTemplate, ExerciseCategory, ExerciseUnit } from '../entities';

export const mockExercises: Partial<ExerciseTemplate>[] = [
  // Strength exercises
  {
    ...
    primaryUnit: 'kilograms' as ExerciseUnit,
  ...
  // Cardio exercises
  {
    ...
    primaryUnit: 'watts' as ExerciseUnit,
  ...
  },
  {
    ...
    primaryUnit: 'meters' as ExerciseUnit,
  ...
  // Mobility exercises
  {
    ...
    primaryUnit: 'seconds' as ExerciseUnit,
    equipment: ['mat'],
  ...
  // Recovery exercises
  {
    ...
    name: 'Foam Rolling',
    category: 'recovery' as ExerciseCategory,
