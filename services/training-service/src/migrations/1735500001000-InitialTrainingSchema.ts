...
export class InitialTrainingSchema1735500001000 implements MigrationInterface {
    name = 'InitialTrainingSchema1735500001000'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        // Add foreign keys
        await queryRunner.createForeignKey("exercises", new ForeignKey({
        ...
        await queryRunner.createForeignKey("player_workout_loads", new ForeignKey({
            columnNames: ["workoutSessionId"],
            referencedColumnNames: ["id"],
            referencedTableName: "workout_sessions",
            onDelete: "CASCADE"
        ...
        await queryRunner.createForeignKey("workout_executions", new ForeignKey({
            columnNames: ["workoutSessionId"],
            referencedColumnNames: ["id"],
            referencedTableName: "workout_sessions",
            onDelete: "CASCADE"
        ...
        await queryRunner.createForeignKey("exercise_executions", new ForeignKey({
        ...
        await queryRunner.createIndex("workout_sessions", new Index({
        ...
        await queryRunner.createIndex("exercise_executions", new Index({
