...
export class InitialTrainingSchema1735500001000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.createForeignKey("player_workout_loads", new TableForeignKey({
            columnNames: ["workoutSessionId"],
            referencedColumnNames: ["id"],
            referencedTableName: "workout_sessions",
            onDelete: "CASCADE"
        ...
        await queryRunner.createForeignKey("workout_executions", new TableForeignKey({
            columnNames: ["workoutSessionId"],
            referencedColumnNames: ["id"],
            referencedTableName: "workout_sessions",
            onDelete: "CASCADE"
        ...
        await queryRunner.createForeignKey("exercise_executions", new TableForeignKey({
        ...
        await queryRunner.createIndex("workout_sessions", new TableIndex({
        ...
        await queryRunner.createIndex("player_workout_loads", new TableIndex({
            name: "IDX_player_workout_loads_workoutSessionId_playerId",
            columnNames: ["workoutSessionId", "playerId"],
            isUnique: true
        }));

        await queryRunner.createIndex("workout_executions", new TableIndex({
        ...
        await queryRunner.createIndex("exercise_executions", new TableIndex({
        ...
        await queryRunner.createIndex("exercise_templates", new TableIndex({
