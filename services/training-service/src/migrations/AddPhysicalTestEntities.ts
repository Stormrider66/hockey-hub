...
export class AddPhysicalTestEntities implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.dropTable('physical_test_results');
    await queryRunner.dropTable('physical_test_definitions');
  }
} 