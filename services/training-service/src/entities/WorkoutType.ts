...
export const defaultWorkoutTypeConfigs: Record<WorkoutType, Partial<WorkoutTypeConfig>> = {
  ...
  [WorkoutType.STABILITY_CORE]: {
    ...
    description: 'Core stability, balance, and proprioceptive training for functional strength',
    metricsConfig: {
      primary: ['duration', 'reps', 'holdTime'],
      secondary: ['instability', 'intensity', 'balance'],
      calculated: [
        { name: 'stabilityScore', formula: '(holdTime * difficulty) / baseline', unit: 'score' },
        { name: 'totalCoreTime', formula: 'sum of all hold times', unit: 'seconds' }
      ]
    },
    equipmentRequirements: {
      required: ['mat', 'stability ball'],
      alternatives: {
        'stability ball': ['balance disc', 'BOSU ball'],
        'mat': ['towel', 'carpet']
      },
      optional: ['balance pad', 'suspension trainer', 'resistance bands', 'foam roller']
    },
    progressionModels: {
      beginner: {
        duration: '0-4 weeks',
        focus: ['basic holds', 'stability awareness', 'breathing coordination'],
        goals: ['30-60 sec holds', 'proper form', 'body awareness']
      },
      intermediate: {
        duration: '1-3 months',
        focus: ['dynamic stability', 'multi-planar movement', 'increased challenge'],
        goals: ['60-90 sec holds', 'unstable surfaces', 'movement control']
      },
      advanced: {
        duration: '3-6 months',
        focus: ['complex patterns', 'sport-specific positions', 'power endurance'],
        goals: ['90+ sec holds', 'reactive stability', 'functional integration']
      },
      elite: {
        duration: '6+ months',
        focus: ['performance optimization', 'injury prevention', 'competition prep'],
        goals: ['advanced patterns', 'maximal stability', 'sport transfer']
      }
    },
    safetyProtocols: {
      warmupRequired: true,
      ...
      cooldownRequired: true,
      cooldownDuration: 5,
      contraindications: ['acute back injury', 'severe balance disorders', 'recent abdominal surgery'],
      injuryPrevention: ['proper alignment', 'gradual progression', 'controlled movements'],
      monitoringRequired: ['form quality', 'balance control', 'fatigue signs'],
      maxIntensity: 80,
      recoveryTime: 24
    }
  },
  [WorkoutType.PLYOMETRICS]: {
    ...
    description: 'Explosive jump and reactive training for power and athleticism',
    metricsConfig: {
      primary: ['reps', 'height', 'distance'],
      secondary: ['contactTime', 'flightTime', 'power'],
      calculated: [
        { name: 'reactiveStrength', formula: 'flightTime / contactTime', unit: 'ratio' },
        { name: 'jumpPower', formula: '(bodyWeight * height) / time', unit: 'watts' }
      ]
    },
    equipmentRequirements: {
      required: ['plyo boxes', 'open space'],
      alternatives: {
        'plyo boxes': ['steps', 'benches', 'platforms'],
        'open space': ['gym floor', 'field', 'track']
      },
      optional: ['hurdles', 'cones', 'medicine balls', 'landing mats']
    },
    progressionModels: {
      beginner: {
        duration: '0-6 weeks',
        focus: ['landing mechanics', 'basic jumps', 'body control'],
        goals: ['safe landings', 'bilateral jumps', 'basic coordination']
      },
      intermediate: {
        duration: '6-12 weeks',
        focus: ['single leg jumps', 'directional changes', 'reactive training'],
        goals: ['unilateral control', 'multi-directional', 'reduced contact time']
      },
      advanced: {
        duration: '3-6 months',
        focus: ['complex movements', 'sport-specific patterns', 'maximal intensity'],
        goals: ['advanced patterns', 'competitive performance', 'injury resilience']
      },
      elite: {
        duration: '6+ months',
        focus: ['peak performance', 'competition preparation', 'specialized protocols'],
        goals: ['world-class performance', 'consistent execution', 'competitive edge']
      }
    },
    safetyProtocols: {
      warmupRequired: true,
      ...
      cooldownRequired: true,
      cooldownDuration: 10,
      contraindications: ['lower limb injuries', 'joint instability', 'poor landing mechanics'],
      injuryPrevention: ['proper landing form', 'adequate rest', 'surface inspection'],
      monitoringRequired: ['landing quality', 'fatigue accumulation', 'contact time'],
      maxIntensity: 100,
      recoveryTime: 48
    }
  },
  [WorkoutType.WRESTLING]: {
    ...
    description: 'Sport-specific grappling techniques, conditioning, and tactical development',
    metricsConfig: {
      primary: ['technique', 'duration', 'intensity'],
      secondary: ['takedowns', 'escapes', 'control'],
      calculated: [
        { name: 'technicalEfficiency', formula: '(successful / attempted) * 100', unit: '%' },
        { name: 'grappleIntensity', formula: 'avgHeartRate / maxHeartRate * 100', unit: '%' }
      ]
    },
    equipmentRequirements: {
      required: ['wrestling mats', 'open space'],
      alternatives: {
        'wrestling mats': ['thick exercise mats', 'padded floor'],
        'open space': ['gym area', 'practice room']
      },
      optional: ['dummy/partner', 'resistance bands', 'agility ladder', 'medicine ball']
    },
    progressionModels: {
      beginner: {
        duration: '0-3 months',
        focus: ['basic positions', 'fundamental moves', 'safety awareness'],
        goals: ['stance and motion', 'basic takedowns', 'mat safety']
      },
      intermediate: {
        duration: '3-12 months',
        focus: ['technique combinations', 'conditioning', 'tactical awareness'],
        goals: ['chain wrestling', 'match conditioning', 'positional control']
      },
      advanced: {
        duration: '1-3 years',
        focus: ['advanced techniques', 'competition prep', 'mental toughness'],
        goals: ['signature moves', 'match strategy', 'peak conditioning']
      },
      elite: {
        duration: '3+ years',
        focus: ['mastery refinement', 'coaching others', 'innovation'],
        goals: ['technical mastery', 'championship level', 'sport development']
      }
    },
    safetyProtocols: {
      warmupRequired: true,
      ...
      cooldownRequired: true,
      cooldownDuration: 15,
      contraindications: ['neck injuries', 'shoulder instability', 'recent concussion'],
      injuryPrevention: ['proper technique', 'controlled intensity', 'mat awareness'],
      monitoringRequired: ['technique form', 'impact force', 'fatigue level'],
      maxIntensity: 95,
      recoveryTime: 24
    }
  }
