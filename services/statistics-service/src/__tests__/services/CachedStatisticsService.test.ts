...
describe('CachedStatisticsService', () => {
  ...
  beforeEach(() => {
    ...
    (CachedPlayerPerformanceRepository as jest.Mock).mockImplementation(() => mockPlayerPerformanceRepo);
    (CachedTeamAnalyticsRepository as jest.Mock).mockImplementation(() => mockTeamAnalyticsRepo);
    (CachedWorkloadAnalyticsRepository as jest.Mock).mockImplementation(() => mockWorkloadRepo);
