...
import { TeamGameStats } from './entities/TeamGameStats';
...
const dataSourceOptions: DataSourceOptions = {
    ...
    entities: [
        ...
        PlayerGameStats,
        TeamGameStats,
        // Path pattern for compiled JS (allows migrations/runtime)
...
AppDataSource.initialize()
    .then(() => {
        console.log('[DB] Statistics Service: Data Source Initialized!');
    })
    .catch((err) => {
        console.error('[DB] Statistics Service: Error during Data Source initialization:', err);
    }); 