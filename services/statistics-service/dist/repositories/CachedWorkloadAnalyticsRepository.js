...
exports.CachedWorkloadAnalyticsRepository = void 0;
const shared_lib_1 = require("@hockey-hub/shared-lib");
class CachedWorkloadAnalyticsRepository extends shared_lib_1.CachedRepository {
    constructor(repository, cacheManager) {
        super(repository, cacheManager, 'workload_analytics');
    }
    async getPlayerWorkloadTrends(playerId, weeks = 8) {
    ...
    async getTeamWorkloadSummary(teamId, weekStartDate) {
    ...
    async getHighRiskPlayers(organizationId, riskThreshold = 70) {
    ...
    async getWorkloadComparison(playerIds, metric = 'totalWorkload') {
    ...
    async getWorkloadOptimizationSuggestions(teamId, weeks = 4) {
        ...
        return this.cacheManager.getOrSet(cacheKey, async () => {
            ...
            const riskTrends = workloads.reduce((acc, w) => {
                ...
                if (!acc[week])
                    acc[week] = { high: 0, critical: 0, total: 0 };
                if (w.riskLevel === 'high')
                    acc[week].high++;
    ...
    async invalidatePlayerWorkload(playerId) {
        const patterns = [
    ...
    async invalidateTeamWorkload(teamId) {
        const patterns = [
...
exports.CachedWorkloadAnalyticsRepository = CachedWorkloadAnalyticsRepository;
//# sourceMappingURL=CachedWorkloadAnalyticsRepository.js.map