...
router.get('/specs/aggregated.json', (_req, res) => {
  res.json(swaggerSpec);
});

router.get('/specs/user.json', (_req, res) => {
  res.json(userServiceSpec);
});

router.get('/specs/medical.json', (_req, res) => {
  res.json(medicalServiceSpec);
});

router.get('/specs/training.json', (_req, res) => {
  res.json(trainingServiceSpec);
});

router.get('/specs/calendar.json', (_req, res) => {
  res.json(calendarServiceSpec);
});

router.get('/specs/communication.json', (_req, res) => {
