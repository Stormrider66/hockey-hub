...
router.get('/players/:playerId', authorize(['player', 'parent', 'medical_staff', 'admin', 'coach']), async (req, res) => {
  try {
...
router.get('/players/:playerId/current', authorize(['player', 'parent', 'medical_staff', 'admin', 'coach']), async (req, res) => {
  try {
    const { playerId } = req.params;
...
router.get('/team/summary', authorize(['medical_staff', 'admin', 'coach']), async (req, res) => {
  try {
