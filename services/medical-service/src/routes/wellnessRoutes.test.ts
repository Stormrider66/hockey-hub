...
import wellnessRoutes, { __setMedicalService, __setWellnessRepository } from './wellnessRoutes';
...
describe('Wellness Routes', () => {
  ...
  beforeEach(() => {
    ...
    mockWellnessRepository = new (CachedWellnessRepository as any)() as jest.Mocked<CachedWellnessRepository>;
    __setMedicalService(mockMedicalService as any);
    __setWellnessRepository(mockWellnessRepository as any);
  });
