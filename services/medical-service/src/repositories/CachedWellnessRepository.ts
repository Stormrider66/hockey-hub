...
import { CachedRepository, CacheKeyBuilder, RedisCacheManager, paginate, PaginationQuery, PaginationResult } from '@hockey-hub/shared-lib';

export class CachedWellnessRepository extends CachedRepository<WellnessEntry> {
  constructor() {
    super(
