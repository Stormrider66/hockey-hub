...
exports.CreateChatTables1735500000000 = void 0;
const typeorm_1 = require("typeorm");
class CreateChatTables1735500000000 {
    async up(queryRunner) {
        ...
        // Create indexes
        await queryRunner.createIndex('conversations', new typeorm_1.Index({
            name: 'IDX_conversations_type_created_at',
            columnNames: ['type', 'created_at'],
        }));
        await queryRunner.createIndex('conversation_participants', new typeorm_1.Index({
        ...
        await queryRunner.createIndex('messages', new typeorm_1.Index({
        ...
        await queryRunner.createIndex('message_attachments', new typeorm_1.Index({
            name: 'IDX_message_attachments_message_id',
            columnNames: ['message_id'],
        }));
        await queryRunner.createIndex('message_reactions', new typeorm_1.Index({
        ...
        await queryRunner.createIndex('message_read_receipts', new typeorm_1.Index({
        ...
        await queryRunner.createIndex('user_presence', new typeorm_1.Index({
...
exports.CreateChatTables1735500000000 = CreateChatTables1735500000000;
//# sourceMappingURL=1735500000000-CreateChatTables.js.map