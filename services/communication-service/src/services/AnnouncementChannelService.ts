...
export class AnnouncementChannelService {
  ...
  private participantRepo = getRepository(ConversationParticipant);
  private messageRepo = getRepository(Message);
  private reactionRepo = getRepository(MessageReaction);
  private readReceiptRepo = getRepository(MessageReadReceipt);
