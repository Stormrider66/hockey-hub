...
export class ParentCommunication extends BaseEntity {
  @Column('uuid')
  @Index()
...
export class ParentCommunicationAttachment extends BaseEntity {
  @Column('uuid')
...
@Index(['reminderDate'])
@Index(['isCompleted'])
export class ParentCommunicationReminder extends BaseEntity {
  @Column('uuid')
  communicationId: string;
