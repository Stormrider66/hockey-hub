...
export function createMedicalDiscussionRoutes(dataSource: DataSource): Router {
  ...
  router.post('/discussions', authMw, async (req: AuthRequest, res: Response, next: NextFunction) => {
    try {
      const { user } = req;
      if (!user) {
  ...
  router.get('/discussions', authMw, async (req: AuthRequest, res: Response, next: NextFunction) => {
    try {
      const { user } = req;
      if (!user) {
        return res.status(401).json({ error: 'Unauthorized' });
  ...
  router.get('/discussions/:id', authMw, async (req: AuthRequest, res: Response, next: NextFunction) => {
    try {
      const { user } = req;
      if (!user) {
        return res.status(401).json({ error: 'Unauthorized' });
  ...
  router.put('/discussions/:id', authMw, async (req: AuthRequest, res: Response, next: NextFunction) => {
    try {
      const { user } = req;
      if (!user) {
        return res.status(401).json({ error: 'Unauthorized' });
  ...
  router.post('/discussions/:id/resolve', authMw, async (req: AuthRequest, res: Response, next: NextFunction) => {
    try {
      const { user } = req;
      if (!user) {
        return res.status(401).json({ error: 'Unauthorized' });
  ...
  router.post('/discussions/:id/archive', authMw, async (req: AuthRequest, res: Response, next: NextFunction) => {
    try {
      const { user } = req;
      if (!user) {
        return res.status(401).json({ error: 'Unauthorized' });
  ...
  router.post('/discussions/:id/viewers', authMw, async (req: AuthRequest, res: Response, next: NextFunction) => {
    try {
      const { user } = req;
      if (!user) {
        return res.status(401).json({ error: 'Unauthorized' });
  ...
  router.delete('/discussions/:id/viewers/:userId', authMw, async (req: AuthRequest, res: Response, next: NextFunction) => {
    try {
      const { user } = req;
      if (!user) {
        return res.status(401).json({ error: 'Unauthorized' });
  ...
  router.post('/discussions/:id/acknowledge', authMw, async (req: AuthRequest, res: Response, next: NextFunction) => {
    try {
      const { user } = req;
      if (!user) {
        return res.status(401).json({ error: 'Unauthorized' });
  ...
  // Create action item
  router.post('/discussions/:id/action-items', authMw, async (req: AuthRequest, res: Response, next: NextFunction) => {
    try {
      const { user } = req;
      if (!user) {
        return res.status(401).json({ error: 'Unauthorized' });
  ...
  router.get('/discussions/:id/action-items', authMw, async (req: AuthRequest, res: Response, next: NextFunction) => {
    try {
      const { user } = req;
      if (!user) {
        return res.status(401).json({ error: 'Unauthorized' });
  ...
  // Update action item
  router.put('/action-items/:id', authMw, async (req: AuthRequest, res: Response, next: NextFunction) => {
    try {
      const { user } = req;
      if (!user) {
        return res.status(401).json({ error: 'Unauthorized' });
  ...
  router.post('/action-items/:id/complete', authMw, async (req: AuthRequest, res: Response, next: NextFunction) => {
    try {
      const { user } = req;
      if (!user) {
        return res.status(401).json({ error: 'Unauthorized' });
  ...
  router.get('/action-items/my', authMw, async (req: AuthRequest, res: Response, next: NextFunction) => {
    try {
      const { user } = req;
      if (!user) {
        return res.status(401).json({ error: 'Unauthorized' });
  ...
  router.get('/discussions/follow-ups/upcoming', authMw, async (req: AuthRequest, res: Response, next: NextFunction) => {
    try {
      const { user } = req;
      if (!user) {
        return res.status(401).json({ error: 'Unauthorized' });
