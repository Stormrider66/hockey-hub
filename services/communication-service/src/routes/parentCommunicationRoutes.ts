...
import { authMiddleware, checkPermission } from '@hockey-hub/shared-lib/middleware';
...
router.post(
  '/',
  checkPermission('parent_communication:create'),
...
router.put(
  '/:id',
  checkPermission('parent_communication:update'),
...
router.get(
  '/:id',
  checkPermission('parent_communication:read'),
...
router.get(
  '/reports/summary',
  checkPermission('parent_communication:report'),
...
router.post(
  '/templates',
  checkPermission('parent_communication:template:create'),
