...
exports.busPublish = exports.subscribe = exports.getBus = void 0;
...
const getBus = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    nc = yield (0, nats_1.connect)({ servers: url, name: 'user-service' });
...
const busPublish = (topic, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const bus = yield (0, exports.getBus)();
    bus.publish(topic, sc.encode(JSON.stringify(payload)));
});
exports.busPublish = busPublish;
