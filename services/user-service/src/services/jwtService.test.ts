...
// Mock modules
jest.mock('fs');
// Polyfill randomUUID for test runtime
// Use real crypto; JWTService falls back to HS256 in tests using JWT_SECRET
...
describe('JWTService', () => {
  ...
  describe('verifyAccessToken', () => {
    ...
    it('should reject expired tokens', async () => {
      ...
      const expiredToken = jwt.sign({ sub: mockUser.id, type: 'access' }, 'test-secret', { expiresIn: -3600 } as any);
