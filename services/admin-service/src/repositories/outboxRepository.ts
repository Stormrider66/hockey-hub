...
export const markFailure = async (id: string, currentAttempts: number, maxRetries = 5, baseDelayMs = 5000) => {
  ...
  if (nextAttempts >= maxRetries) {
    ...
    const delay = Math.pow(2, nextAttempts) * baseDelayMs; // exponential backoff
