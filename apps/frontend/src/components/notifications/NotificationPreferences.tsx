...
export const NotificationPreferences: React.FC = () => {
  ...
  const handleSave = async () => {
    try {
      const updatedPreferences: NotificationPreference[] = [] as any;
      ...
      Object.values(NotificationType).forEach(type => {
        Object.values(NotificationChannel).forEach(channel => {
          ...
          // Cast to full type for API update; backend can infer missing fields
          updatedPreferences.push(preference as NotificationPreference);
        });
      });
