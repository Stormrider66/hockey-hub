...
const TrainingSessionDetails: React.FC<TrainingSessionDetailsProps> = ({
  ...
  const { data: session, isLoading: sessionLoading } = useGetWorkoutSessionByIdQuery(sessionId);
    ...
    <>
      ...
      {selectedPlayerId && (
        <CreatePerformanceReview
          ...
          trainingDiscussionId={discussion?.id}
          sessionDate={session ? new Date(session.scheduledDate) : undefined}
