...
export default function PlayerDashboard() {
  ...
  const { t } = isTestEnv
    ...
    : useTranslationsPkg(['player', 'common']) as any;
  ...
  const playerNumericId = getUserId();
    ...
    <div className={`p-4 md:p-6 ${spacing.section}`}>
      ...
      <Tabs value={tab} onValueChange={setTab} className={spacing.card}>
        <TabsList className="grid w-full grid-cols-2 md:grid-cols-6" role="tablist">
          ...
          <TabsTrigger value="tactical" id="tactical-tab" aria-controls="tactical-panel">Tactical</TabsTrigger>
        ...
        <TabsContent value="today" className={spacing.card} role="tabpanel" id="today-panel" aria-labelledby="today-tab">
          <div className={grids.dashboard}>
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <Button 
                            ...
                            onClick={() => {
                              ...
                              const isCardio = String(w.type || '').toUpperCase() === 'CARDIO';
                              if (isCardio && w.intervalProgram) {
                                launchInterval(w);
                              } else {
                          ...
                          >
                            ...
                            {String((workout as any).type || '').toUpperCase() === 'CARDIO' && (workout as any).intervalProgram ? 'Start Interval Training' : 'Start Workout'}
                          </Button>
                        </div>
                      </div>
                    ))
            ...
            {/* Tactical Learning */}
            <Card className={`${shadows.card} border-blue-200 bg-gradient-to-br from-blue-50 to-indigo-50`}>
              <CardHeader className="pb-2">
                <CardTitle className="flex items-center gap-2">
                  <Brain className="h-5 w-5 text-blue-600" aria-hidden="true" />
                  Tactical Learning
                </CardTitle>
                <CardDescription>Master your team's playbook</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-medium">Play Mastery</span>
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 pt-2">
                    <div className="text-center">
                      ...
                      <div className="text-xs text-muted-foreground">Plays Mastered</div>
                    </div>
                    <div className="text-center">
                  ...
                  <div className="space-y-2 pt-2 border-t">
                    <div className="flex items-center gap-2">
                      ...
                      <div className="text-xs">
                        <span className="font-medium">Power Play Formation A</span>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div className="text-xs">
                        <span className="font-medium">New: Defensive Coverage</span>
        ...
        {/* ───────────  TACTICAL  ─────────── */}
        <TabsContent value="tactical" className={spacing.card} role="tabpanel" id="tactical-panel" aria-labelledby="tactical-tab">
