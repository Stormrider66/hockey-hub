...
import { Plus, Trash2, Clock, Dumbbell, Heart } from 'lucide-react';
...
export default function HybridWorkoutBuilderSimple({
  ...
  const totalDuration = blocks.reduce((sum, b) => sum + b.duration, 0);
  const isValid = programName && blocks.length > 0 && (selectedPlayers.length > 0 || selectedTeams.length > 0);
  ...
  return (
    <div className="space-y-4">
      ...
      <PlayerTeamAssignment
        ...
        description="Select players and teams for this hybrid workout. Medical restrictions will be considered during execution."
