...
export const ExerciseLibrary: React.FC<ExerciseLibraryProps> = ({ filters, onFilterChange }) => {
  ...
  const handleCategoryChange = (category: SessionPhaseType | 'all') => {
  ...
  const handleDifficultyChange = (difficulty: 'beginner' | 'intermediate' | 'advanced' | 'all') => {
