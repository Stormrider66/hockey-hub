...
import type { AgilityDrill, AgilityDrillCategory } from '../../types/agility.types';
...
const CATEGORY_ICONS: Record<AgilityDrillCategory, React.ReactNode> = {
  ...
  sport_specific: <Sparkles className="h-4 w-4" />,
...
export default function DrillLibrary({
  ...
  const filteredDrills = useMemo(() => {
    return EXTENDED_DRILL_LIBRARY.filter(drill => {
          ...
          <div className="flex gap-4">
            <div className="flex-1">
              <div className="relative">
                ...
                <Input
                  placeholder={t('physicalTrainer:agility.library.search')}
                  value={searchTerm}
