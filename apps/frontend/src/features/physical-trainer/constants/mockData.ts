...
export const mockPlayerReadiness = [
  ...
  { id: 3, playerId: '3', name: 'Viktor Nilsson', status: 'rest' as const, load: 110, fatigue: 'high' as const, trend: 'down' as const, lastUpdated: new Date().toISOString() },
  ...
  { id: 5, playerId: '5', name: 'Anders Johansson', status: 'caution' as const, load: 92, fatigue: 'medium' as const, trend: 'stable' as const, lastUpdated: new Date().toISOString() }
];
