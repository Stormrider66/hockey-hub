...
export const AvailabilityPollCard: React.FC<AvailabilityPollCardProps> = ({
  ...
  const [submitResponse] = useScheduleClarificationApi.useSubmitPollResponseMutation();
  const [finalizePoll] = useScheduleClarificationApi.useFinalizePollDecisionMutation();
