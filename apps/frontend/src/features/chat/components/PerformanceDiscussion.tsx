    ...
    <div className="flex flex-col h-full">
      ...
      <Tabs value={selectedTab} onValueChange={setSelectedTab} className="flex-1 flex flex-col">
        ...
        <TabsContent value="overview" className="flex-1 p-4 space-y-4 overflow-y-auto">
          ...
          {/* Strengths */}
          {Array.isArray(discussion.strengths) && discussion.strengths.length > 0 && (
            <Card>
              <CardHeader>
          ...
          {Array.isArray(discussion.areas_for_improvement) && discussion.areas_for_improvement.length > 0 && (
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
          ...
          {Array.isArray(discussion.training_recommendations) && discussion.training_recommendations.length > 0 && (
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
        ...
        <TabsContent value="goals" className="flex-1 p-4 space-y-4 overflow-y-auto">
          {/* Goals */}
          {Array.isArray(discussion.goals) && discussion.goals.length > 0 && (
            <div className="space-y-3">
          ...
          {/* Action Items */}
          {Array.isArray(discussion.action_items) && discussion.action_items.length > 0 && (
            <div className="space-y-3">
              <h3 className="font-semibold flex items-center gap-2">
