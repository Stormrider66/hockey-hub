...
export const CreateAvailabilityPollModal: React.FC<CreateAvailabilityPollModalProps> = ({
  ...
  const [createPoll, { isLoading }] = useScheduleClarificationApi.useCreateAvailabilityPollMutation();
    ...
    try {
      await createPoll({
        ...
        options: validOptions.map((opt, index) => ({
          ...
          description: opt.description || this.getOptionDescription(opt, pollType),
        })),
