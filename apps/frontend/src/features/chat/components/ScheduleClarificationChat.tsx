...
export const ScheduleClarificationChat: React.FC<ScheduleClarificationChatProps> = ({
  ...
  } = useScheduleClarificationApi.useGetClarificationQuery(clarificationId);

  const {
    data: carpoolOffers,
    isLoading: carpoolLoading,
  } = useScheduleClarificationApi.useGetCarpoolOffersQuery({
    clarificationId,
  });
  ...
  } = useScheduleClarificationApi.useGetPollsQuery({
    clarificationId,
  });

  const [updateStatus] = useScheduleClarificationApi.useUpdateClarificationStatusMutation();
