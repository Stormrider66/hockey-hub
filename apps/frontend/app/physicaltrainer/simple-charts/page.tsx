...
} from '@/features/physical-trainer/components/charts/SimpleChartAdapter';
...
export default function SimpleChartsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8">
      ...
      <div className="mb-8 flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold">Simple Chart Adapter Test</h1>
          <p className="text-gray-600 mt-2">
            Self-contained chart components with feature flag switching
          </p>
        </div>
        ...
        <Card>
          ...
          <CardContent>
            <SimpleLineChart
              ...
              height={250}
              lines={[
                { dataKey: 'value', stroke: '#8884d8', strokeWidth: 2, name: 'Actual' },
                { dataKey: 'baseline', stroke: '#82ca9d', strokeDasharray: '5 5', name: 'Baseline' },
                { dataKey: 'goal', stroke: '#ffc658', strokeDasharray: '5 5', name: 'Goal' }
              ]}
            />
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <SimpleAreaChart
              ...
              height={250}
              areas={[
                { dataKey: 'value', stroke: '#8884d8', fill: '#8884d8', fillOpacity: 0.6, name: 'Actual' },
                { dataKey: 'baseline', stroke: '#82ca9d', fill: '#82ca9d', fillOpacity: 0.3, name: 'Baseline' }
              ]}
            />
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <SimpleBarChart
              ...
              height={250}
              bars={[
                { dataKey: 'value', fill: '#8884d8', name: 'Current' },
                { dataKey: 'average', fill: '#82ca9d', name: 'Average' }
              ]}
            />
          </CardContent>
        </Card>
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-lg font-semibold">
                  {useLightweightCharts ? '~50KB' : '~150KB (lazy loaded)'}
                </p>
              </div>
              <div>
