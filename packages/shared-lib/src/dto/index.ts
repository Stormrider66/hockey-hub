...
// Export order matters to avoid circular initialization in decorators
export * from './interval-program.dto';
export * from './workout-settings.dto';
// Explicit re-exports to avoid duplicate symbol merging conflicts in TS project refs
export { CreateWorkoutSessionDto, UpdateWorkoutSessionDto } from './workout-session.dto';
