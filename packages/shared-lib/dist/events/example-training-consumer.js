...
exports.ExampleTrainingEventConsumer = void 0;
const shared_lib_1 = require("@hockey-hub/shared-lib");
class ExampleTrainingEventConsumer {
    constructor() {
        const eventBus = (0, shared_lib_1.getGlobalEventBus)();
        this.listeners = (0, shared_lib_1.createTrainingEventListeners)(eventBus);
        this.logger = new shared_lib_1.Logger('ExampleTrainingEventConsumer');
    }
    /**
    ...
    initialize() {
        ...
        this.listeners.onWorkoutCompleted(async (event) => {
            ...
            try {
                ...
                this.logger.error('Failed to update player statistics', error);
            }
        });
        ...
        this.listeners.onInjuryReported(async (event) => {
            ...
            try {
                ...
                this.logger.error('Failed to notify medical staff', error);
            }
        });
        ...
        this.listeners.onMilestoneAchieved(async (event) => {
            ...
            try {
                ...
                this.logger.error('Failed to create achievement notification', error);
            }
        });
        ...
        this.listeners.onPlanCompleted(async (event) => {
            ...
            try {
                ...
                this.logger.error('Failed to generate completion report', error);
            }
        });
        // Listen to all training events for audit logging
        this.listeners.onAnyTrainingEvent(async (event) => {
            this.logger.audit('Training event', {
                type: event.type,
...
exports.ExampleTrainingEventConsumer = ExampleTrainingEventConsumer;
...
*/ 
//# sourceMappingURL=example-training-consumer.js.map